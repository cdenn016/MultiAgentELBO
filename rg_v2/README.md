...
`multiagent_elbo` package. Run the click-to-run laboratory from the repository
root with:

```powershell
C:\Python314\python.exe run_renormalization_v2_lab.py
```

Run its focused regression gate with:
...
The Release 1 run contract publishes six semantic artifacts:
