...
| Vault: gabrielli-2025 | READ. Three-step program; GR/LRG/MSM table; failure taxonomy, recorded there as 'renormalizability = additivity of the defining parameter' — SUPERSEDED: that framing is protocol-relative and is refuted by the phi-GRW family; see claim-table row 71; scale-free ≠ scale-invariant; §6 open problems incl. **simultaneous renormalization of topology and dynamics** and **"Parameter (ir)relevance: an information-theoretic perspective"** (prose, zero equations — promissory note). |
