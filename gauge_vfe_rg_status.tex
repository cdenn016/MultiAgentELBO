...
measured in \S10.1: in the coarse-graining direction it is under about one percent
of the pairwise coupling.
...
so a three-body parent coupling is generated, it is nonzero, and it is under about
one percent of the pairwise coupling, with a flow-weighted residual of a few parts
in a thousand. The orders decay rather than staying comparable. That is the
...
three-body coupling under about one percent of its pairwise one.}
\label{fig:star}
\end{figure}
...
parent coupling under about one percent of the pairwise scale, with the orders
